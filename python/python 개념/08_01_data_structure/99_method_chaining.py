...
# [실수 2] append()가 반환한 None 뒤에 메서드를 이을 수 없음  ########################## extend()도 None을 반환
numbers.append(7).extend(
    [8, 9]
)  # AttributeError: 'NoneType' object has no attribute 'extend'
# new_list = old_list.append(4)  # new_list는 None을 반환  # 조심해야하는 코드 실수 자주함 #######################################
...
# sorted()는 정렬된 '새로운 리스트'를 반환하므로 변수에 할당 가능  # sort는 원본을 바꿈
